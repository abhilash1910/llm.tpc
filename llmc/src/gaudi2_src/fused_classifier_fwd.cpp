...
extern unsigned char _binary___fused_classifier_fwd_o_start;
extern unsigned char _binary___fused_classifier_fwd_o_end;

 tpc_lib_api::GlueCodeReturn fused_classifier_fwd::GetKernelName(
             char kernelName [tpc_lib_api::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_fused_classifier_fwd");
     return tpc_lib_api::GLUE_SUCCESS;
 }


tpc_lib_api::GlueCodeReturn fused_classifier_fwd::GetGcDefinitions(
            tpc_lib_api::HabanaKernelParams* in_defs,
            tpc_lib_api::HabanaKernelInstantiation* out_defs)
{
    tpc_lib_api::GlueCodeReturn retVal;
    const int c_unrollCount = 4;
    fused_classifier_fwd* call_params = static_cast<fused_classifier_fwd*>(in_defs->nodeParams.nodeParams);
    ...
    **************************************************************************************/
    ...
    out_defs->kernel.scalarParams[2] = static_cast<uint32_t>(call_params->V);
    out_defs->kernel.scalarParams[3] = static_cast<uint32_t>(call_params->P);
    out_defs->kernel.scalarParams[4] = static_cast<bool>(call_params->WRITE_LOGITS);
    out_defs->kernel.scalarParams[5] = static_cast<bool>(call_params->WRITE_PROBS);
    
    
    /*************************************************************************************
    *    Stage V -  Load ISA into the descriptor.
    **************************************************************************************/
    unsigned IsaSize = (&_binary___fused_classifier_fwd_o_end - &_binary___fused_classifier_fwd_o_start);
    ...
    if (givenBinarySize >= IsaSize)
    {
        ...
        memcpy (out_defs->kernel.kernelElf,
                &_binary___fused_classifier_fwd_o_start,
                IsaSize);
    }
    else
    {
