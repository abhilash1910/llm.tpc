...
extern unsigned char _binary___attention_fwd_o_start;
extern unsigned char _binary___attention_fwd_o_end;

 tpc_lib_api::GlueCodeReturn attention_fwd::GetKernelName(
             char kernelName [tpc_lib_api::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_attention_fwd");
     return tpc_lib_api::GLUE_SUCCESS;
 }


tpc_lib_api::GlueCodeReturn attention_fwd::GetGcDefinitions(
            ...
            tpc_lib_api::HabanaKernelInstantiation* out_defs)
{
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___attention_fwd_o_end - &_binary___attention_fwd_o_start);
    ...
    if (givenBinarySize >= IsaSize)
    {
        ...
        memcpy (out_defs->kernel.kernelElf,
                &_binary___attention_fwd_o_start,
                IsaSize);
    }
    else
    {
