...
extern unsigned char _binary___matmul_fwd_o_start;
extern unsigned char _binary___matmul_fwd_o_end;

 tpc_lib_api::GlueCodeReturn matmul_fwd::GetKernelName(
             char kernelName [tpc_lib_api::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_matmul_fwd");
            ...
            tpc_lib_api::HabanaKernelInstantiation* out_defs)
{
    ...
    matmul_fwd* call_params = static_cast<matmul_fwd*>(in_defs->nodeParams.nodeParams);
    ...
    **************************************************************************************/
    unsigned IsaSize = (&_binary___matmul_fwd_o_end - &_binary___matmul_fwd_o_start);
