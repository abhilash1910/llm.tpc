...
extern unsigned char _binary___adamw_o_start;
extern unsigned char _binary___adamw_o_end;

 tpc_lib_api::GlueCodeReturn adamw::GetKernelName(
             char kernelName [tpc_lib_api::MAX_NODE_NAME])
 {
     strcpy(kernelName,"custom_adamw");
     return tpc_lib_api::GLUE_SUCCESS;
 }


tpc_lib_api::GlueCodeReturn adamw::GetGcDefinitions(
            tpc_lib_api::HabanaKernelParams* in_defs,
            tpc_lib_api::HabanaKernelInstantiation* out_defs)
{
    tpc_lib_api::GlueCodeReturn retVal;
    const int c_unrollCount = 4;
    adamw* call_params = static_cast<adamw*>(in_defs->nodeParams.nodeParams);
    ...
    **************************************************************************************/
    ...
    out_defs->kernel.paramsNr = 8;
    out_defs->kernel.scalarParams[0] = static_cast<float>(call_params->beta1);
    out_defs->kernel.scalarParams[1] = static_cast<float>(call_params->beta2);
    out_defs->kernel.scalarParams[2] = static_cast<float>(call_params->epsilon);
    out_defs->kernel.scalarParams[3] = static_cast<float>(call_params->beta1_correction);
    out_defs->kernel.scalarParams[4] = static_cast<float>(call_params->beta2_correction);
    out_defs->kernel.scalarParams[5] = static_cast<float>(call_params->weight_decay);
    out_defs->kernel.scalarParams[6] = static_cast<float>(call_params->grad_scale);
    out_defs->kernel.scalarParams[7] = static_cast<int>(call_params->seed);
    
    
    /*************************************************************************************
    *    Stage V -  Load ISA into the descriptor.
    **************************************************************************************/
    unsigned IsaSize = (&_binary___adamw_o_end - &_binary___adamw_o_start);
